...
class ReportController extends Controller
{
  ...
  public function add_new_report(Request $request){
    ...
    if($inserted)
    {
      return redirect('incompanies/reports')->with('alert-success', 'Report Has Been Inserted Successfully');
    }
    else
    {
      return redirect('incompanies/reports/add')->with('alert-error', 'Something whent wrong');
    }
  }
  public function add(){
    return view('in.reports.add');
  }
  ...
  public function add_new_report_id(Request $request,$id){
    ...
    if($inserted)
    {
      ...
      return redirect('incompanies/reports');
    }
    else
    {
      flash('Error')->error();
      return redirect('incompanies/reports/add_report'.$id);
    }
  }
}
